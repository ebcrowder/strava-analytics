...
var Graph = function Graph() {
            ...
            case 5:
              ...
              formattedStravaData = json.map(function (activity) {
                if (activity.type === 'Run') {
                  return {
                    Run: activity.distance * 0.000621371
                  };
                } else {
                  return {
                    Ride: Mactivity.distance * 0.000621371
                  };
                }
              });
  ...
  console.log(data);
  return react__WEBPACK_IMPORTED_MODULE_3___default.a.createElement(_nivo_stream__WEBPACK_IMPORTED_MODULE_4__["ResponsiveStream"], {
    data: data,
    keys: ['Run', 'Ride'],
    margin: {
      top: 50,
...
//# sourceMappingURL=index.js.4a6c65d3a06b4eded5f0.hot-update.js.map