            ...
            case 5:
              ...
              elevationGainData = json.map(function (activity) {
                if (activity.type === 'Run') {
                  return {
                    type: 'Run',
                    ele: activity.total_elevation_gain
                  };
                } else {
                  return {
                    type: 'Ride',
                    heartRate: activity.total_elevation_gain
                  };
                }
              });
              setData(elevationGainData);
...
//# sourceMappingURL=index.js.6c8caa27afcb8d231315.hot-update.js.map