...
var Graph = function Graph() {
  ...
  function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var res, json, distanceData, heartRateData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              heartRateData = json.map(function (activity) {
                if (activity.type === 'Run') {
                  return {
                    type: 'Run',
                    heartRate: Math.round(activity.distance * 0.000621371)
                  };
                } else {
                  return {
                    type: 'Ride',
...
//# sourceMappingURL=index.js.57029cac59639a7ed6e1.hot-update.js.map